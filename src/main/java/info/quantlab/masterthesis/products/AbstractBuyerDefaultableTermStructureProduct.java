 ...
 * <ul>
 * <li> <b>AbstractBuyerDefaultableTermStructureProduct (this class):</b> The model assumes the buyer is defaultable. 
 ...
 * <li> <b>AbstractSellerDefaultableTermStructureProduct:</b> A seller that is defaultable. E.g. typical vanilla options, 
 ...
 *
 */
public abstract class AbstractBuyerDefaultableTermStructureProduct extends AbstractTermStructureMonteCarloProduct {

	public AbstractBuyerDefaultableTermStructureProduct() {
		super();
	}

	public AbstractBuyerDefaultableTermStructureProduct(String currency) {
		super(currency);
	}
